...
## Using templates in views.py
  - in project folder > app folder > `views.py` delete import for HttpResponse object as it is no longer needed
  - 
  - Templates are in project folder > app folder > templates
